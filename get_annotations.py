...
def main():
    ...
    for file_name in file_list:
        ...
        if ext == u'.xml':
            ...
            #abs_name = data_dir_path + '/' + "patient_099_node_4.xml"
            ...
            image = cv2.resize(image, (int(width * 1/256), int(height * 1/256)))
            ...
            cv2.imwrite("./data_hm/" + file_name + ".jpg", image)
            #cv2.imwrite("./data_hm/" + "patient_051_node_2.xml" + ".jpg", image)
